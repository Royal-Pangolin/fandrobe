...
@section('content')
    ...
    <div class="w-full px-4 md:px-6 flex items-center justify-center"
        style="min-height: calc(100vh - 76px); padding-top: 76px;">

        <div class="confirm-container text-center" style="max-width: 520px; width: 100%;">

            <div class="confirm-icon-circle inline-flex items-center justify-center rounded-full mb-5">
            ...
            <h1 class="confirm-title font-bold mb-3">¡Pedido confirmado!</h1>
            ...
            <div class="flex items-center gap-3 mb-5 opacity-25">
