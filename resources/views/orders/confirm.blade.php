...
@section('content')
<div class="container-fluid px-4 px-lg-5 py-5 d-flex align-items-center justify-content-center"
     style="min-height: calc(100vh - 76px);">

    <div style="height: 76px; position: absolute; top: 0;"></div>
    ...
    <div class="text-center" style="max-width: 520px; width: 100%;">
        ...
        {{-- Título --}}
        <h1 class="fw-bolder mb-3" style="font-size: clamp(2rem, 5vw, 3rem); letter-spacing: -0.03em; line-height: 1.05;">
            ¡Pedido confirmado!
        </h1>
        ...
        @else
            <p class="mb-5" style="font-size: 1.1rem; color: var(--color-muted); line-height: 1.7; max-width: 420px; margin: 0 auto 2rem;">
                Hemos recibido tu pedido y lo estamos preparando con cuidado. Te avisaremos cuando esté en camino.
            </p>
        @endif
