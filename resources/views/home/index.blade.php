...
@section('content')
    ...
    {{-- ============================================================
         HERO: Slideshow de artistas al estilo Shazam
    ============================================================ --}}
        ...
        <div class="hero-slides position-absolute top-0 start-0 w-100 h-100">
            @forelse ($heroArtists as $i => $artist)
                <div class="hero-slide position-absolute top-0 start-0 w-100 h-100 {{ $i === 0 ? 'active' : '' }}"
                     data-index="{{ $i }}"
                     style="background-color: {{ ['#4B352A','#2A3B4B','#3B4B2A','#4B2A3B','#2A4B3B','#3B2A4B'][$i % 6] }};">
                    <div class="position-absolute top-50 start-50 translate-middle text-white opacity-10"
                         style="font-size: 40vw; font-weight: 900; line-height: 1; user-select: none; pointer-events: none;">
                ...
                <div class="col-lg-7">
                    <div class="hero-artist-name mb-3">
                        ...
                        @if($heroArtists->isEmpty())
                            <span class="text-white fw-bold text-uppercase" style="letter-spacing: 0.15em; font-size: 0.9rem; opacity: 0.8;">Descubre nuestros artistas</span>
                        @endif
                    </div>
                    ...
                    <p class="text-white mb-5" style="font-size: 1.125rem; max-width: 520px; opacity: 0.85; line-height: 1.7;">
    ...
    {{-- ============================================================
         ÚLTIMOS LANZAMIENTOS — Fila horizontal con scroll
    ============================================================ --}}
