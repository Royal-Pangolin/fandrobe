                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="admin-card p-4 rounded-4 h-100">
                        ...
                        <a href="{{ route('admin.pedidos.index') }}"
                            class="text-decoration-none fw-bold small text-verified">Ver pedidos →</a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="admin-card p-4 rounded-4 h-100">
                        ...
                        <a href="{{ route('admin.pedidos.index') }}"
                            class="text-decoration-none fw-bold small text-verified">Gestionar →</a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="admin-card p-4 rounded-4 h-100">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="admin-card p-4 rounded-4 h-100">
                        ...
                        <a href="{{ route('admin.usuarios.index') }}"
                            class="text-decoration-none fw-bold small text-verified">Ver usuarios →</a>
                    </div>
                </div>
            </div>
