...
<body class="bg-body text-dark d-flex flex-column min-vh-100">
    ...
    <footer class="site-footer py-5 mt-auto">
        <div class="container-fluid px-4 px-lg-5">
            <div class="row g-5">
                <div class="col-md-5">
                    <a href="{{ route('home') }}" class="footer-brand d-flex align-items-center mb-3 text-decoration-none fw-bolder fs-4">
                        <svg class="me-2" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M9 18V5l12-2v13"/>
                            <circle cx="6" cy="18" r="3"/>
                            <circle cx="18" cy="16" r="3"/>
                ...
                <div class="col-md-3 offset-md-1">
                    ...
                    <ul class="footer-nav-list list-unstyled d-flex flex-column gap-2">
                        <li><a href="{{ route('products.index') }}" class="footer-link text-decoration-none fw-medium">Catálogo</a></li>
                        <li><a href="{{ route('artists.index') }}" class="footer-link text-decoration-none fw-medium">Artistas</a></li>
                ...
                <div class="col-md-3">
                    ...
                    <ul class="footer-nav-list list-unstyled d-flex flex-column gap-2">
                        ...
                        <li><a href="#" class="footer-link text-decoration-none fw-medium">Envíos y devoluciones</a></li>
                        <li><a href="#" class="footer-link text-decoration-none fw-medium">FAQ</a></li>
                    </ul>
                </div>
            </div>

            <div class="footer-bottom mt-5 pt-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
